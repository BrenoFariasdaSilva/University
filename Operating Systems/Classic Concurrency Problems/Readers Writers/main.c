/*
AUTORES: BRENO FARIAS DA SILVA
*/

/* Implementar o problema classico de concorrencia leitores/escritores usando semaforos */
// Leitores podem ler simultaneamente, mas apenas um escritor pode escrever simultaneamente.
